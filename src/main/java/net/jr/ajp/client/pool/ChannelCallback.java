...
public interface ChannelCallback {
	...
	/**
	 * Called before doWithChannel in order to clean/configure it (like modifiying pipeline, etc..)
	 */
	...
	/**
	 * Called before the channel is returned to the pool. one may want to clean the channel (remove pipeline, etc)
	 * 
	 * @param channel
	 */
